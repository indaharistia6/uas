...
<div class="page-content-wrapper">
	...
	<button class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#tambah_akomodasi">Tambah Akomodasi</button>
<br><br>
	<table class="table table-bordered">
		...
		foreach($akomodasi as $a) : ?>
			...
			<tr>
				...
				<td class="text-center"><?php echo anchor('admin/data_akomodasi/edit/' .$a->id, '<div class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></div>') ?></td>
				<td onclick="javascript: return confirm('Anda yakin hapus?')" class="text-center"><?php echo anchor('admin/data_akomodasi/hapus/' .$a->id, '<div class="btn btn-danger btn-sm"><i class="fa fa-times"></i></div>') ?></td>
			</tr>
